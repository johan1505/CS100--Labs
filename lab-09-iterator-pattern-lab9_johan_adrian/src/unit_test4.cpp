...
TEST(PrecisionOpTest, PrecisionOp){
	...
	EXPECT_EQ(sub->stringify(), "1.23000 - -23.500000000");	

	Base* mult = new Mult(op3, op1);
	EXPECT_EQ(mult->stringify(), "0.00 * 1.2435");	
}
...
TEST(DoubleFactoryTest, DoubleFactory){
	...
	EXPECT_EQ(div->stringify(), "79.000000 / 84.000000");
}
